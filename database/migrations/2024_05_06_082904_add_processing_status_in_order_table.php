...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE `order` CHANGE `status` `status` ENUM('pending', 'dispatched','rejected') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL;");
    }
};
