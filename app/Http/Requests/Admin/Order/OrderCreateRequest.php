...
class OrderCreateRequest extends FormRequest
{
    ...
    {
        return auth()->user()->can('order_create');
    }
    ...
    public function messages()
    {
        return [
            ...
            'total_price.required' => 'At least one product required for request an order',
            'total_price.min' => 'At least one product required for request an order',
        ];
    }
