...
class ContentsCreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            'name' => 'required',
            'title' => 'required',
            'slug' => 'nullable|unique:contents,slug,slug',
            'file' => 'required|mimes:application/msword,application/pdf,application/vnd.ms-excel,application/vnd.ms-powerpoint,application/zip,audio/mpeg,audio/mp3,image/gif,image/jpeg,image/webp,text/plain,video/x-m4v,jpeg,jpg,png,pdf',
