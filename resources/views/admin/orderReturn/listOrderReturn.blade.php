@section('title', 'List Order Returns')

@push('script')
    <script src="{{ mix('js/admin/orderReturn/listOrderReturn.js') }}"></script>
@endpush

@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/orderReturn/listOrderReturn.css') }}">
@endpush
...
<x-admin-layout :breadcrumbs="$breadcrumbs">
    ...
    <div class="card">
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listOrderReturns" data-url="{{ route('admin_order_return_table') }}">
                <thead>
