...
@push('script')
    <script src="{{ mix('js/admin/application/listApplication.js') }}"></script>
@endpush

@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/application/listApplication.css') }}">
@endpush
        ...
        <div class="card-header border-0 pt-6">
            <x-dt-toolbar>
                ...
                @can('application_create')
                    <a href="{{ route('admin_application_add') }}" class="btn btn-primary">Add Application</a>
                @endcan
            </x-dt-toolbar>
        </div>
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listApplications" data-url="{{ route('admin_application_table') }}">
                <thead>
