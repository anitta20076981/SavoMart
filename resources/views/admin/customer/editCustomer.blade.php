...
@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/customer/editCustomer.css') }}">
@endpush

@push('script')
    <script src="{{ mix('js/admin/customer/editCustomer.js') }}"></script>
@endpush
...
<x-admin-layout>
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        <div id="kt_content_container" class="container-xxl">
            <form novalidate="novalidate" id="customerUpdateForm" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin_customer_update') }}" enctype="multipart/form-data" method="POST">
                @csrf
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="first_name" class="form-control mb-2" placeholder="First Name" value="{{ old('first_name', $customer->first_name) }}">
                                                @error('first_name')
                                            ...
                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="last_name" class="form-control mb-2" placeholder="Last Name" value="{{ old('last_name', $customer->last_name) }}">
                                                @error('last_name')
                                                    <div class="fv-plugins-message-container invalid-feedback"> {{ $message }} </div>
                                                @enderror
                                            </div>
                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                ...
                                                <input type="text" name="email" class="form-control mb-2" placeholder="Email" value="{{ old('email', $customer->email) }}">
                                                @error('email')
                                                    <div class="fv-plugins-message-container invalid-feedback"> {{ $message }} </div>
                                                @enderror
                                            </div>
                                            <div class="mb-10 fv-row fv-plugins-icon-container">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="d-flex flex-column col-md-8">
                                                        <input type="number" name="phone" class="form-control mb-2" placeholder="Phone" value="{{ old('phone', $customer->phone) }}">
                                                    </div>
                                                    @error('phone')
                                                        <div class="fv-plugins-message-container invalid-feedback"> {{ $message }} </div>
                                                    @enderror
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="row">
                                            <div class="mb-2 col-6 fv-row">
                                                ...
                                                <textarea id="address_line1" name="address_line1" class="form-control mb-2">{{ old('address_line1', $customer->customerDetails->address_line1 ?? '') }}</textarea>
                                                @error('address_line1')
                                                    <div class="fv-plugins-message-container invalid-feedback"> {{ $message }} </div>
                                                @enderror
                                            </div>
                                            <div class="mb-2 col-6 fv-row">
                                                ...
                                                <input type="number" name="number" class="form-control mb-2" placeholder="Phone Number" value="{{ old('number', $customer->customerDetails->number ?? '') }}">
                                                @error('number')
                                                    <div class="fv-plugins-message-container invalid-feedback"> {{ $message }} </div>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="mb-2 col-6 fv-row">
                                                ...
                                                <textarea id="street" name="street" class="form-control mb-2">{{ old('street', $customer->customerDetails->number ?? '') }}</textarea>
                                                @error('street')
                                                    <div class="fv-plugins-message-container invalid-feedback"> {{ $message }} </div>
                                                @enderror
                                            </div>
