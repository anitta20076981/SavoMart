        ...
        @foreach ($productArray as $key => $product)
            <tr data-variation-row="{{ $key }}">
                ...
                <td class="p-5 fv-row fv-plugins-icon-container">
                    <input type="text" class="form-control varient-sku" value="{{ $productSku . '-' . $product['attribute_values'] }}" name="product_variations[{{ $key }}][sku]" data-fv-not-empty="true" data-fv-not-empty___message="The sku is required">
                ...
                <td><input type="number" class="form-control" value="{{ $productQty }}" name="product_variations[{{ $key }}][qty]"></td>
                <td>
