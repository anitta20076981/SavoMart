@section('title', 'List Pending Products')

@push('script')
    <script src="{{ mix('js/admin/products/listPendingProducts.js') }}"></script>
@endpush

@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/products/listPendingProducts.css') }}">
@endpush
...
<x-admin-layout :breadcrumbs="$breadcrumbs">
    ...
    <div class="card">
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="listPendingProducts" data-url="{{ route('admin_products_pending_table') }}">
                <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Stock Status</th>
                        <th class="min-w-80px">Quantity</th>
                        <th class="min-w-85px">Price</th>
                        <th class="min-w-75px">Vendor</th>
