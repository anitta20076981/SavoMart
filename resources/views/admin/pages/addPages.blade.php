...
@push('style')
    <link rel="stylesheet" type="text/css" href="{{ mix('css/admin/pages/addPages.css') }}">
@endpush

@push('script')
    <script src="{{ mix('js/admin/pages/addPages.js') }}"></script>
@endpush

<x-admin-layout :breadcrumbs="$breadcrumbs">
    <x-toolbar :breadcrumbs="$breadcrumbs"></x-toolbar>
    <form novalidate="novalidate" id="PagesForm" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework" action="{{ route('admin_pages_save') }}" enctype="multipart/form-data" method="POST">
        @csrf
            ...
            <div class="card card-flush py-4">
                <div class="card-header">
                    ...
                    <div class="card-toolbar">
                        <div class="rounded-circle bg-success w-15px h-15px" id="page_status"></div>
                    </div>
                </div>
