...
window.SavoMartJson = {};
window.SavoMartJson.lang = {};
window.SavoMartJson.options = {};
...
window.FormValidation.plugins.Bootstrap5 =
    require("../../../plugins/formvalidation/dist/amd/plugins/Bootstrap5.js").default;
...
// SavoMartthemes'
window.SavoMartComponents = require("./components/_init.js");
window.SavoMartUtil = require("./components/util.js");
window.SavoMartApp = require("./components/app.js");
window.SavoMartEventHandler = require("./components/event-handler.js");
window.SavoMartBlockUI = require("./components/blockui.js");
window.SavoMartFlatPicker = require('./components/flatPicker.js');
window.SavoMartCookie = require("./components/cookie.js");
// window.SavoMartDialer = require("./components/dialer.js");
window.SavoMartDrawer = require("./components/drawer.js");
window.SavoMartFeedback = require("./components/feedback.js");
window.SavoMartImageInput = require("./components/image-input.js");
window.SavoMartMenu = require("./components/menu.js");
window.SavoMartPasswordMeter = require("./components/password-meter.js");
window.SavoMartScroll = require("./components/scroll.js");
window.SavoMartScrolltop = require("./components/scrolltop.js");
// window.SavoMartSearch = require('./components/search.js');
window.SavoMartModal = require('./components/modal.js');
window.SavoMartForm = require("./components/form.js");
window.SavoMartFormValidation = require('./components/formValidation.js');

window.SavoMartStepper = require("./components/stepper.js");
window.SavoMartSticky = require("./components/sticky.js");
window.SavoMartSwapper = require("./components/swapper.js");
window.SavoMartToggle = require("./components/toggle.js");

// Layout base js
window.SavoMartLayoutAside = require("./layout/aside.js");
// window.SavoMartLayoutSearch = require('./layout/search.js');
window.SavoMartLayoutToolbar = require("./layout/toolbar.js");
window.SavoMartThemeMode = require("./layout/theme-mode.js");
window.SavoMartThemeModeUser = require("./layout/theme-mode-user.js");
