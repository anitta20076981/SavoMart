...
// Class definition
var SavoMartPlayersWidget1 = function () {
    // Private methods
    var initPlayers = function () {
        // https://www.w3schools.com/jsref/dom_obj_audio.asp
        // Toggle Handler
        SavoMartUtil.on(document.body, '[data-kt-element="list-play-button"]', 'click', function (e) {
...
if (typeof module !== 'undefined') {
    module.exports = SavoMartPlayersWidget1;
}

// Window load
window.addEventListener("load", function () {
    SavoMartPlayersWidget1.init();
});