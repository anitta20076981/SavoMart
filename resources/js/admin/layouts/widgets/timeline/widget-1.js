...
// Class definition
var SavoMartTimelineWidget1 = function () {
    // Private methods
    // Day timeline
    const initTimelineDay = () => {
        ...
        var options = {
            ...
            onInitialDrawComplete: function () {
                ...
                const blockUI = SavoMartBlockUI.getInstance(target);
    ...
    const handleBlockUI = () => {
        ...
        elements.forEach(element => {
            const blockUI = new SavoMartBlockUI(element, {
...
if (typeof module !== 'undefined') {
    module.exports = SavoMartTimelineWidget1;
}

// On document ready
SavoMartUtil.onDOMContentLoaded(function () {
    SavoMartTimelineWidget1.init();
});