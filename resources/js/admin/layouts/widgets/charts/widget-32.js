...
// Class definition
var SavoMartChartsWidget32 = function () {
    var chart1 = {
        self: null,
        rendered: false
    };
    ...
    var initChart = function (chart, toggle, chartSelector, data, initByDefault) {
        ...
        var labelColor = SavoMartUtil.getCssVariableValue('--bs-gray-900');
        ...
        var options = {
            ...
            colors: [SavoMartUtil.getCssVariableValue('--bs-primary'), SavoMartUtil.getCssVariableValue('--bs-primary-light')],
            grid: {
...
if (typeof module !== 'undefined') {
    module.exports = SavoMartChartsWidget32;
}

// On document ready
SavoMartUtil.onDOMContentLoaded(function () {
    SavoMartChartsWidget32.init();
});