...
// Class definition
var SavoMartChartsWidget8 = function () {
    var chart1 = {
        self: null,
        rendered: false
    };
    ...
    var initChart = function (chart, toggle, selector, data, initByDefault) {
        ...
        var borderColor = SavoMartUtil.getCssVariableValue('--bs-border-dashed-color');
        ...
        var options = {
            ...
            xaxis: {
                ...
                labels: {
                    ...
                    trim: true,
                    style: {
                        colors: SavoMartUtil.getCssVariableValue('--bs-gray-500'),
                        fontSize: '13px'
                    }
                }
            },
            ...
            crosshairs: {
                ...
                position: 'front',
                stroke: {
                    color: SavoMartUtil.getCssVariableValue('--bs-border-dashed-color'),
                    width: 1,
                    dashArray: 0,
                }
            },
            colors: [
                SavoMartUtil.getCssVariableValue('--bs-primary'),
                SavoMartUtil.getCssVariableValue('--bs-success'),
                SavoMartUtil.getCssVariableValue('--bs-warning'),
                SavoMartUtil.getCssVariableValue('--bs-danger'),
                SavoMartUtil.getCssVariableValue('--bs-info'),
                '#43CED7'
            ],
            fill: {
                opacity: 1,
    ...
    return {
        init: function () {
            ...
            var handlerId = SavoMartThemeMode.on("kt.thememode.change", function () {
                if (chart1.rendered) {
                    chart1.self.destroy();
                }
...
if (typeof module !== 'undefined') {
    module.exports = SavoMartChartsWidget8;
}

// On document ready
SavoMartUtil.onDOMContentLoaded(function () {
    SavoMartChartsWidget8.init();
});