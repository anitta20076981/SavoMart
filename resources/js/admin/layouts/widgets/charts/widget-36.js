...
// Class definition
var SavoMartChartsWidget36 = function () {
    var chart = {
        self: null,
        rendered: false
    };
    ...
    var initChart = function (chart) {
        ...
        var baseprimaryColor = SavoMartUtil.getCssVariableValue('--bs-primary');
        var lightprimaryColor = SavoMartUtil.getCssVariableValue('--bs-primary');
        var basesuccessColor = SavoMartUtil.getCssVariableValue('--bs-success');
        var lightsuccessColor = SavoMartUtil.getCssVariableValue('--bs-success');
...
if (typeof module !== 'undefined') {
    module.exports = SavoMartChartsWidget36;
}

// On document ready
SavoMartUtil.onDOMContentLoaded(function () {
    SavoMartChartsWidget36.init();
});