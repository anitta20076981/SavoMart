...
// Class definition
var SavoMartChartsWidget16 = (function () {
    // Private methods
        ...
        var init = function () {
            ...
            var paretoSeries = chart.series.push(
                am5xy.LineSeries.new(root, {
                    ...
                    valueYField: "pareto",
                    categoryXField: "country",
                    stroke: am5.color(SavoMartUtil.getCssVariableValue('--bs-dark')),
                    maskBullets: false,
                })
            );
...
if (typeof module !== "undefined") {
    module.exports = SavoMartChartsWidget16;
}

// On document ready
SavoMartUtil.onDOMContentLoaded(function () {
    SavoMartChartsWidget16.init();
});