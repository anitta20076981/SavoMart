...
// Class definition
var SavoMartChartsWidget5 = function () {
    var chart = {
        self: null,
        rendered: false
    };
        ...
        var options = {
            ...
            xaxis: {
                ...
                labels: {
                    ...
                    style: {
                        colors: SavoMartUtil.getCssVariableValue('--bs-gray-400'),
                        fontSize: '14px',
                        fontWeight: '600',
                        align: 'left'
                    }
            ...
            yaxis: {
                labels: {
                    style: {
                        colors: SavoMartUtil.getCssVariableValue('--bs-gray-800'),
                        fontSize: '14px',
                        fontWeight: '600'
                    },
                    offsetY: 2,
...
if (typeof module !== 'undefined') {
    module.exports = SavoMartChartsWidget5;
}

// On document ready
SavoMartUtil.onDOMContentLoaded(function () {
    SavoMartChartsWidget5.init();
});