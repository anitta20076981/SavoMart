...
// Class definition
var SavoMartCardsWidget4 = function () {
    // Private methods
    var initChart = function () {
        ...
        drawCircle(SavoMartUtil.getCssVariableValue('--bs-danger'), options.lineWidth, 100 / 150);
        drawCircle(SavoMartUtil.getCssVariableValue('--bs-primary'), options.lineWidth, 100 / 250);
    }
...
if (typeof module !== 'undefined') {
    module.exports = SavoMartCardsWidget4;
}

// On document ready
SavoMartUtil.onDOMContentLoaded(function () {
    SavoMartCardsWidget4.init();
});