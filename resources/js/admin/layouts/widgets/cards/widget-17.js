...
// Class definition
var SavoMartCardsWidget17 = function () {
    // Private methods
    var initChart = function () {
        ...
        drawCircle(SavoMartUtil.getCssVariableValue('--bs-primary'), options.lineWidth, 100 / 150);
        drawCircle(SavoMartUtil.getCssVariableValue('--bs-success'), options.lineWidth, 100 / 250);
    }
...
if (typeof module !== 'undefined') {
    module.exports = SavoMartCardsWidget17;
}

// On document ready
SavoMartUtil.onDOMContentLoaded(function () {
    SavoMartCardsWidget17.init();
});