...
// Class definition
var SavoMartAppLayoutBuilder = function () {
    var form;
    var actionInput;
    var url;
    var previewButton;
    ...
    var handleEngagePrebuilts = function () {
        ...
        if (SavoMartCookie.get("app_engage_prebuilts_modal_displayed") !== "1") {
            setTimeout(function () {
                const modal = new bootstrap.Modal(engagePrebuiltsModal);
                modal.show();

                const date = new Date(Date.now() + 30 * 24 * 60 * 60 * 1000); // 30 days from now
                SavoMartCookie.set("app_engage_prebuilts_modal_displayed", "1", { expires: date });
            }, 3000);
        }
    }
    ...
    var handleEngagePrebuiltsViewMenu = function () {
        ...
        // Toggle Handler
        SavoMartUtil.on(engagePrebuiltsModal, '[data-kt-mode]', 'click', function (e) {
    ...
    var handleEngageToggle = function () {
        engageToggleOff.addEventListener("click", function (e) {
            ...
            SavoMartCookie.set("app_engage_hide", "1", { expires: date });
        ...
        engageToggleOn.addEventListener("click", function (e) {
            ...
            SavoMartCookie.remove("app_engage_hide");
            ...
            $.ajax({
                ...
                success: function (response, status, xhr) {
                    ...
                    toastr.success(
                        ...
                        "Preview updated!", { timeOut: 0, extendedTimeOut: 0, closeButton: true, closeDuration: 0 }
                    );
                ...
                error: function (response) {
                    toastr.error(
                        ...
                        "Something went wrong!", { timeOut: 0, extendedTimeOut: 0, closeButton: true, closeDuration: 0 }
                    );
                },
                complete: function () {
    ...
    var handleExport = function () {
        exportButton.addEventListener("click", function (e) {
            ...
            toastr.success(
                ...
                "Generating HTML!", { timeOut: 0, extendedTimeOut: 0, closeButton: true, closeDuration: 0 }
            );
            ...
            $.ajax({
                ...
                success: function (response, status, xhr) {
                    ...
                    toastr.success(
                        ...
                        "Reset Preview!", { timeOut: 0, extendedTimeOut: 0, closeButton: true, closeDuration: 0 }
                    );
    ...
    var handleThemeMode = function () {
        ...
        var check = document.querySelector('#kt_layout_builder_theme_mode_' + SavoMartThemeMode.getMode());
        ...
        if (checkLight) {
            checkLight.addEventListener("click", function () {
                ...
                SavoMartThemeMode.setMode('light');
            });
        }
        ...
        if (checkDark) {
            checkDark.addEventListener("click", function () {
                ...
                this.closest('[data-kt-buttons="true"]').querySelector('.form-check-image.active').classList.remove('active');
                this.closest('.form-check-image').classList.add('active');
                SavoMartThemeMode.setMode('dark');
            });
        }
